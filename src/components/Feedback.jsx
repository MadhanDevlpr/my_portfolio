    ...
    return (
        <div className="feedbk" id="feedback">
            ...
            <div className="wrap-input">
                <input required data-aos="zoom-in" data-aos-delay="500" data-aos-duration="1000" data-aos-once="true" required="" placeholder="Email" type="email" name="Email" /><br />
                <input required data-aos="zoom-out" data-aos-delay="800" data-aos-duration="1000" data-aos-once="true" required="" placeholder="Name" type="text" name="Name" /><br /><br />
            </div><br /><br />
