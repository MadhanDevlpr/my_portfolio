...
function Footer() {
    return (
        <div className="footer">
            ...
            <a class="github-button"  href="https://github.com/MadhanDevlpr/React.js-Portfolio" data-size="large" data-show-count="true" aria-label="Star MadhanDevlpr/React.js-Portfolio on GitHub">Star</a><br />
