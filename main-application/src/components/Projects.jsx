            ...
            <div className="projects">
                ...
                <div className="cards">
                    <div  data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" data-aos-once="true" className="card" >
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/weatherapp-js"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div  data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000" data-aos-once="true" className="card" >
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/Js-Clock"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/fabulousfolio"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/snake-game"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/GK-QUIZ"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/Jarvis"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/Background-Generator"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/GUI-CLOCK"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000" data-aos-once="true" className="card" >
                        <div className="card-body">
                        ...
                        <a target="_blank" rel="noreferrer" href="https://github.com/MadhanDevlpr/tts"><button type="button" className="btn btn-dark">Github</button></a>
                        </div>
                    </div>
                </div>
            </div>
